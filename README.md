...
Yoda 是面向真实研发交付的本地优先 AI Coding 工作台。它把多模型对话、代码执行、项目上下文、任务编排、协作子 Agent、自动任务和持续知识沉淀整合在一个桌面应用中。

**[English](./README.en.md)** · **[下载最新版本](https://github.com/biajidong/Yoda/releases)** · **[使用指南](./apps/electron/resources/tutorial.md)**
...
Yoda 的主入口是 **Code** 模式（默认）。读写文件、执行命令、修改代码、项目管理、任务编排、自动化，以及问答、分析、写作等知识工作都可以在 Code 中完成。
...
从 [GitHub Releases](https://github.com/biajidong/Yoda/releases) 下载适用于 macOS 或 Windows 的安装包。
...
应用默认进入 **Code** 模式。讨论、分析和写作，或修改工程、运行命令、执行多步骤任务，都可以直接开始。
...
- Yoda 会向 Code Agent 明确提供当前 Workspace、Project、会话及附加目录；当前版本不提供 OS 级文件系统沙箱，完全自动模式只应在可信环境中使用；
...
Yoda 基于开源社区持续演进，并受益于以下项目和生态：

- [Proma](https://github.com/proma-ai/Proma)：Yoda 的早期开源基础；
