...
import type { AgentThinkingLevel, CodeClawThemeId } from '@yoda/shared'
import { CODECLAW_THEMES, DEFAULT_AGENT_THINKING_LEVEL, DEFAULT_CODECLAW_THEME_ID, isCodeClawThemeId } from '@yoda/shared'
    ...
    <div className="space-y-6">
      ...
      >
        <SettingsCard>
          ...
          <SettingsToggle
            label="CodeClaw"
            description="在桌面显示 Yoda Agent 助手：执行中、完成、错误或需要你接手时用动画提醒"
          ...
          <SettingsToggle
            label="Git/PR 标识"
            description="Agent 代你提交 commit 或创建 PR 时，附加 Made-with: Yoda 与仓库链接，便于推广；可随时关闭"
