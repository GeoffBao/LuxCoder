/**
 * AppLogoSettings - MyYoda 品牌 Logo 下载
 *
...
import transparentLogo from '@/assets/bots/logos/transparent.png'
...
const LOGO_VARIANTS: readonly LogoVariant[] = [
  ...
  },
  {
    ...
    description: '蓝紫渐变背景',
    src: gradientLogo,
    resourcePath: 'logos/gradient.png',
  ...
  },
  {
    ...
    src: transparentLogo,
    resourcePath: 'logos/transparent.png',
  ...
  },
  {
    ...
    src: veriPeriLogo,
    resourcePath: 'logos/veri-peri.png',
    previewBg: 'bg-[#6667AB]',
  },
  {
    id: 'viva-magenta',
    ...
    src: vivaMagentaLogo,
    resourcePath: 'logos/viva-magenta.png',
    previewBg: 'bg-[#BB2649]',
  },
  {
    id: 'mocha-mousse',
    ...
    src: mochaMousseLogo,
    resourcePath: 'logos/mocha-mousse.png',
    previewBg: 'bg-[#A47764]',
  },
  {
    id: 'emerald',
    ...
    src: emeraldLogo,
    resourcePath: 'logos/emerald.png',
    previewBg: 'bg-[#009473]',
  },
  // 科技风格
  {
  ...
  },
  {
    ...
    description: '霓虹赛博风格',
    src: cyberpunkLogo,
    resourcePath: 'logos/cyberpunk.png',
    previewBg: 'bg-[#0d0221]',
  },
  {
    id: 'futuristic',
    ...
    description: '金属全息科技风',
    src: futuristicLogo,
    resourcePath: 'logos/futuristic.png',
    previewBg: 'bg-[#4a4a4a]',
  },
] as const
...
export function AppLogoSettings(): React.ReactElement {
  return (
    <>
      <SettingsSection
        title="品牌 Logo"
        description="下载 MyYoda Logo 用作机器人头像，让用户一眼认出你的 AI 助手"
      >
