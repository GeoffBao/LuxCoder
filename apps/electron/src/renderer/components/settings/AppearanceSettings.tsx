 ...
 *
 * "主题模式"只有浅色/深色/跟随系统三个标签；浅色、深色标签下面各自挂着「Yoda 精选」
 * （旧版具名主题）+「更多预设」（迁移自 Craft 的预设）两组卡片，只显示当前标签对应的那个
 * 变体。Yoda 精选旁提供 classic/modern 选择，Craft 更多预设固定使用现代工作台。
            ...
            <div className="border-t border-border px-4 py-3 space-y-3">
              <div className="space-y-1.5">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <div className="text-xs font-medium text-muted-foreground">Yoda 精选</div>
