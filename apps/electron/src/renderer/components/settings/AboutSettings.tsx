...
import type { EnvironmentCheckResult, RuntimeStatus } from '@luxagents/shared'
import {
  SettingsSection,
  SettingsCard,
  SettingsRow,
...
function UpdateCard(): React.ReactElement | null {
  ...
  const [release, setRelease] = React.useState<import('@luxagents/shared').GitHubRelease | null>(null)
