...
import type { FeishuBotBridgeState, FeishuBridgeState, DingTalkBotBridgeState, DingTalkBridgeState } from '@yoda/shared'
...
import { diffCapabilities, UPDATER_LINKS } from '@yoda/shared'
import type { GitHubRelease, WorkspaceCapabilities } from '@yoda/shared'
...
import { YodaLogo } from './lib/model-logo'
...
const windowKind = windowKindFromQuery ?? window.__yodaWindowKind
    ...
    toast.custom((toastId) => (
      <div className="w-[344px] max-w-[calc(100vw-32px)] rounded-xl bg-background/95 p-3 text-foreground shadow-[0_12px_32px_rgba(0,0,0,0.14)] ring-1 ring-black/5 backdrop-blur-xl dark:ring-white/10">
        <div className="flex items-center gap-2.5">
          <img src={YodaLogo} alt="Yoda" className="size-8 rounded-lg" />
    ...
    toast.custom((toastId) => (
      <div className="w-[344px] max-w-[calc(100vw-32px)] rounded-xl bg-background/95 p-3 text-foreground shadow-[0_12px_32px_rgba(0,0,0,0.14)] ring-1 ring-black/5 backdrop-blur-xl dark:ring-white/10">
        <div className="flex items-center gap-2.5">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-1.5 text-sm leading-5">
              <span className="font-semibold tracking-tight">Yoda 更新已下载</span>
              <span className="text-xs text-primary">{versionLabel}</span>
            </div>
                  ...
                  .then((scheduled) => {
                    ...
                    toast.custom((scheduledToastId) => (
                      <div className="w-[312px] max-w-[calc(100vw-32px)] rounded-xl bg-background/95 p-3 text-foreground shadow-[0_12px_32px_rgba(0,0,0,0.14)] ring-1 ring-black/5 backdrop-blur-xl dark:ring-white/10">
                        <div className="flex items-center gap-2.5">
                          <img src={YodaLogo} alt="Yoda" className="size-7 rounded-md" />
                          <div className="min-w-0 flex-1">
