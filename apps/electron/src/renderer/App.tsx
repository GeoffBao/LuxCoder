...
import yodaMarkWhite from './assets/brand/yoda-mark-white.svg'
...
export default function App(): React.ReactElement {
  ...
  const handleOnboardingComplete = async (action?: OnboardingCompleteAction) => {
    ...
    if (action === 'tutorial') {
      ...
      const result = openTab(tabs, { type: 'tutorial', sessionId: TUTORIAL_TAB_ID, title: 'Yoda 使用指南' })
    ...
    >
      ...
      <div className="relative flex w-full max-w-sm flex-col items-center px-8 text-center">
        <div className="flex items-center gap-3">
          ...
          />
          <span className="text-xl font-light tracking-wide">Yoda</span>
        </div>
        ...
        <p className="mt-4 text-sm font-medium tracking-[0.08em] text-white/95">正在启动 Yoda</p>
