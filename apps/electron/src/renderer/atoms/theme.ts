 ...
 * - themeModeAtom: 用户选择的主题模式，持久化到 ~/.luxagents/settings.json
...
/** localStorage 缓存键 */
const THEME_CACHE_KEY = 'luxagents-theme-mode'
const THEME_STYLE_CACHE_KEY = 'luxagents-theme-style'
const INTERFACE_VARIANT_CACHE_KEY = 'luxagents-interface-variant'
