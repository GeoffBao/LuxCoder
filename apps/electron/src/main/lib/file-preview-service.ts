...
import type { OfficePreviewResult } from '@luxcodex/shared'
...
function getPreviewTmpDir(): string {
  const dir = join(tmpdir(), 'luxcodex-preview')
  if (!existsSync(dir)) {
