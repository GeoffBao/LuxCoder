...
import type { OfficePreviewResult } from '@luxagents/shared'
...
function getPreviewTmpDir(): string {
  const dir = join(tmpdir(), 'luxagents-preview')
  if (!existsSync(dir)) {
