...
import type { CodexOAuthCredentials, CodexOAuthDeviceCode, CodexOAuthLoginMethod } from '@yoda/shared'
...
/**
 * Pi 的 ModelRuntime 只要求 CredentialStore 的结构契约。OAuth 凭据仍由 Yoda
 ...
 * Yoda 的代理 fetch 重新接回该流程；本 service 只负责与公开 ModelRuntime 交互。
 */
