...
import { loadTaskRecord, loadTaskSpec, taskDir } from '@yoda/shared/tasks/storage'
import {
...
const roots: string[] = []
function root(): string { const value = mkdtempSync(join(tmpdir(), 'yoda-materialize-')); roots.push(value); return value }
