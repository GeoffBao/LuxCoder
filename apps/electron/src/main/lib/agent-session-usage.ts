 ...
 *
 * 数据来源：~/.luxagents/agent-sessions/{id}.jsonl 里最后一条带 usage 的消息。
 * 优先级：
...
import { calculateContextUsageRatio, inferAgentSdkContextWindow, inferContextWindow } from '@luxagents/shared'
import type { SDKAssistantMessage, SDKResultMessage } from '@luxagents/shared'
