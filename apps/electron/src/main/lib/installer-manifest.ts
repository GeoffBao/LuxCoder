...
import type { InstallerManifest, InstallerSource } from '@luxcodex/shared'

const MANIFEST_URL = 'https://raw.githubusercontent.com/GeoffBao/LuxCodex/main/installer-manifest.json'
  ...
  try {
    const response = await fetch(MANIFEST_URL, {
      headers: {
        ...
        'User-Agent': 'LuxCodex-Desktop-App',
      },
    })
