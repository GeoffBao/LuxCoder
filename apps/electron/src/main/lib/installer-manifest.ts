...
import type { InstallerManifest, InstallerSource } from '@yoda/shared'

const MANIFEST_URL = 'https://raw.githubusercontent.com/GeoffBao/Yoda/main/installer-manifest.json'
