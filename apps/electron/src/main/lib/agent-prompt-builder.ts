...
>>>>>>> f95d658e (fix(agent): require Pi write content (#1184))
...
LuxAgents 统一使用 collaboration 派生子会话承载子 Agent 委派。不要使用 SDK 临时 SubAgent、Agent 工具或 Task 工具来拆分子任务；这些临时 sidechain 不进入 LuxAgents 会话体系，不利于追踪、恢复和继续协作。
