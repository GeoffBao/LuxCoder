...
const binName = isWindows ? 'yoda.exe' : 'yoda'
...
console.log(`${color.cyan}[build:cli]${color.reset} 编译 yoda CLI → ${color.dim}${outFile}${color.reset}`)
