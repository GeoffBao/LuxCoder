...
> Live Canvas：`yoda-native-feature-log.canvas.tsx`  
...
| Agent专家 | ~/.yoda/experts · expertId | SHIPPED | keep | 尚无 session/mcpIds/Bot 注入 |
...
| 品牌 / 路径 | @yoda · ~/.yoda · yoda_event | EVOLVING | rename-map | migration 可读 ~/.proma |
