# proma-thinking · Sync / Feature 档案索引

Cursor **Canvas**（可在对话旁打开）只能放在托管目录：

`~/.cursor/projects/Users-admin-Workspace-ClaudeCode-Yoda/canvases/*.canvas.tsx`

本目录放 **git 可跟踪** 的 Markdown 维护源；两边内容应对齐。

| 档案 | Markdown（本目录） | Canvas（侧栏） |
|---|---|---|
...
| 自研大 feature | [yoda-native-feature-log.md](./yoda-native-feature-log.md) | `yoda-native-feature-log.canvas.tsx` |
...
历史思考原文仍保留：`proma-2026-q1-thinking.md` / `proma-2026-q2-q3-thinking.md`。
